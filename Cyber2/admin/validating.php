        ...
        <div class="content">
            ...
            <div class="col-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h3 class="mb-4">Validate Payment Details</h3>
                                    ...
                                    <tbody>
                                        <?php $i = 1; while ( $list = mysqli_fetch_array($unpaid)) { ?>
                                            <tr>
                                                ...
                                                <td><?php echo $list['MOP'] ?></td>
                                                <td><?php echo $list['Transaction_code'] ?></td>
                                                <td><a href="validating.php?paid=<?php echo $list['ordersID'] ?>" class="btn btn-primary">Validate Payment</a></td>
                                            </tr>
                                        <?php }?>
                                    </tbody>
                                </table>
