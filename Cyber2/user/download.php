        ...
        <div class="content">
            ...
            <div class="col-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h3 class="mb-4">Download Paid Digital Products</h3>
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <?php $i = 1; while ( $list = mysqli_fetch_array($paid)) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="rate.php?rate=<?php echo $list['ordersID'] ?>" class="btn btn-primary">Give a Rate</a>
                                                </td>
                                            </tr>
                                        <?php }?>
                                    </tbody>
