...
if (isset($_SESSION['login']) && $_SESSION['login'] === true) {
    ...
    $fetchCartQuery = "SELECT * FROM user_orders WHERE id = $userId";
    $fetchCartResult = mysqli_query($conn, $fetchCartQuery);

    // Count the number of rows in user_orders
    $cartItemCount = mysqli_num_rows($fetchCartResult);
...
<head>
  ...
  <style>
    ...
    * {
    ...
    .wish-cart-bar::before {
      content: "";
      position: absolute;
      border: 2px #611fc6 solid;
...
<body>
  <div class="nav-bar">
    <div class="nav-sidebar">
      ...
      <div class="nav-col">
        <a class="cyber-logo" href="#"><img src="/CYBER+/assets/images/cyber+logo.png"></a>
      </div>

      <div class="nav-col">


        <a class="nav-button" href="/CYBER+/store.php" role="button" aria-haspopup="true" aria-expanded="false">STORE</a>
        <a class="nav-button" href="/CYBER+/faq.php" role="button" aria-haspopup="true" aria-expanded="false">FAQ</a>
        <a class="nav-button" href="#" role="button" aria-haspopup="true" aria-expanded="false" onclick="show_help()">HELP</a>
        <a class="nav-button" href="/CYBER+/about-us.php" role="button" aria-haspopup="true" aria-expanded="false">ABOUT CYBER+</a>
      </div>

      <!--sign in-->

      <div class="nav-col">
        <a class="nav-button-2 gap" onclick="profile(<?php echo $_SESSION['id'] ?>)" role="button" aria-haspopup="true" aria-expanded="false">PROFILE</a>
        <a class="nav-button-2 gap" href="/CYBER+/logout.php" role="button" aria-haspopup="true" aria-expanded="false">LOGOUT</a>
      </div>
    </div>
  </div>
  ...
  <div class="nav-sidebar-2">
    ...
    <div class="nav-col">
      <a class="nav-button-2" href="/CYBER+/store-genre.php" role="button" aria-haspopup="true" aria-expanded="false">GENRE</a>

      <a class="nav-button-2" href="/CYBER+/store-new-release.php" role="button" aria-haspopup="true" aria-expanded="false">NEW RELEASE</a>
      <a class="nav-button-2" href="/CYBER+/store-a-z.php" role="button" aria-haspopup="true" aria-expanded="false">A - Z</a>
    </div>

    <div class="nav-col">
      <div class="search-bar">
        <input type="text" class="search-input" aria-label="search" placeholder="Enter your search">
        <button class="search-btn" aria-label="submit search"><img src="/CYBER+/assets/images/search.png"></button>
      </div>
    </div>
    ...
    <div class="wish-cart-bar">
      ...
      <a class="nav-button-2" href="/CYBER+/addgames.php" role="button" aria-haspopup="true" aria-expanded="false">ADD GAMES</a>

      <a class="nav-button-2" href="/CYBER+/mycart.php" role="button" aria-haspopup="true" aria-expanded="false">MY CART (<?php echo $cartItemCount; ?>)</a>
    </div>
  </div>
  </div>
